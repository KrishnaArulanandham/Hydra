    ...
    <div>
        ...
        <div class="container">
          <div class="navbar-translate">
            ...
            <a class="navbar-brand" href="https://www.example.com">
              <img
                src="C:\Users\sanja\Downloads\Blunual.jpg_-removebg-preview.png"
                alt="Logo"
                style="height:130px;"
              />
            </a>
      ...
      <div class="wrapper">
        <div
          ...
          style="background-image: url('https://pixnio.com/free-images/2017/05/04/2017-05-04-06-49-31.jpg')"
        >
          <div class="filter"></div>
          <div class="content-center">
            <div class="container">
              <div class="title-brand">
                <h1 class="presentation-title">BLUNUAL</h1>
                <div class="fog-low">
                  <img
